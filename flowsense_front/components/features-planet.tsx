...
export default function FeaturesPlanet() {
  ...
  const [translations, setTranslations] = useState<{
    realTimeRiskAlerts?: string;
    realTimeRiskAlertsDesc?: string;
    routeOptimization?: string;
    routeOptimizationDesc?: string;
    driverBehaviorAnalysis?: string;
    driverBehaviorAnalysisDesc?: string;
    predictiveRiskMapping?: string;
    predictiveRiskMappingDesc?: string;
    communitySafetyInsights?: string;
    communitySafetyInsightsDesc?: string;
    incidentReporting?: string;
    incidentReportingDesc?: string;
    reduceRisks?: string;
  }>({});
    ...
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            {translations.reduceRisks}
            </h2>
          </div>
          {/* Planet */}
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-orange-900 before:to-white-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.orange.200),transparent)]">
                <Image
      ...
      <article>
        <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
          ...
          <span>{translations.realTimeRiskAlerts}</span>
        </h3>
        <p className="text-[15px] text-gray-400">
          {translations.realTimeRiskAlertsDesc}
        </p>
      </article>
      <article>
        <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
          ...
          <span>{translations.routeOptimization}</span>
        </h3>
        <p className="text-[15px] text-gray-400">
          {translations.routeOptimizationDesc}
        </p>
      </article>
      <article>
        <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
          ...
          <span>{translations.driverBehaviorAnalysis}</span>
        </h3>
        <p className="text-[15px] text-gray-400">
          {translations.driverBehaviorAnalysisDesc}
        </p>
      </article>
      <article>
        <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
          ...
          <span>{translations.predictiveRiskMapping}</span>
        </h3>
        <p className="text-[15px] text-gray-400">
          {translations.predictiveRiskMappingDesc}
        </p>
      </article>
      <article>
        <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
          ...
          <span>{translations.communitySafetyInsights}</span>
        </h3>
        <p className="text-[15px] text-gray-400">
          {translations.communitySafetyInsightsDesc}
        </p>
      </article>
      <article>
        <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
          ...
          <span>{translations.incidentReporting}</span>
        </h3>
        <p className="text-[15px] text-gray-400">
          {translations.incidentReportingDesc}
        </p>
      </article>
    </div>
        </div>
